...
@section('title','ຈັດການຂໍ້ມູນຮູບພາບຂອງຫ້ອງເເຖວ')
@section('contain')
    ...
    <section class="content container-fluid">
        ...
        <div class="col-lg-12 m-t-5">
            <div class="pull-right">
                <a style="background-color:#5499C7;border:1px solid black; " class="btn btn-success" href="{{route('create.image')}}"><i style="color: wheat;" class="fas fa-folder-plus"></i> ເພິມຮູບພາບຂອງຫ້ອງເເຖວ</a>
            </div>
        </div>
        </div>

        <div style="margin-top: -45px;" class="col-md-4">
            <form action="/image/search" method="get" class="sidebar-form">
                ...
                <tr>
                    ...
                    <th>ເຫດການ</th>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-primary" href="{{URL::to('edit/edit/image/'.$item->id)}}"><i class="fas fa-edit"></i></a>
                                    <a class="btn btn-danger" href="{{URL::to('delete/image/'.$item->id)}}"
