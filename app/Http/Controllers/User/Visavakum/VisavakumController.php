...
namespace App\Http\Controllers\User\Visavakum;
...
class VisavakumController extends Controller
{
    ...
    public function show($id)
    {
        ...
        return view('user.visavakum.show',compact('dormitory','imagess','userss','schoolss','dormitoryss'));
    }
